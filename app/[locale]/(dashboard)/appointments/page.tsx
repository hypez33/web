    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Planen Sie Services, senden Sie automatische E-Mails mit ICS-Anhang und verfolgen Sie Status.
          </p>
        </div>
        <Link
      ...
      <section className="rounded-3xl border border-muted bg-card/90 p-6 text-center shadow-sm shadow-black/5">
        ...
        <h2 className="mt-4 text-lg font-semibold text-foreground">
          Terminmodul in Vorbereitung
        </h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Demnächst können hier Servicepartner benachrichtigt, ICS-Dateien versendet und Rückmeldungen verarbeitet werden.
        </p>
      </section>
    </div>
  );
